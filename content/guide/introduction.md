...
But before we start making the next million dollar discord bot, we'll need to learn a few things
...
- [Writing Effective & Idiomatic Go](https://go.dev/doc/effective_go)
- [A collection of examples for common topics & patterns of Go](https://gobyexample.com)
- [The complete Documentations of the Go programming language](https://go.dev/doc/)
